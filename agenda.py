    ...
    def on_aceptar(self):  
        ...
        if self.nombre=='' or self.apellido=='' :
            ...
            if self.it_is==False or self.it_is_p == False:
                ...
                if self.operacion=='A':
                    ret = QMessageBox.question (self, 'Nuevo Contacto' , "Para Confirmar click en un botón Ok" , QMessageBox.Ok | QMessageBox.No | QMessageBox.Cancel, QMessageBox.Cancel)
                    if ret == QMessageBox.Ok: 
                ...
                if self.operacion=='M':
                    ret = QMessageBox.question (self, 'Editar Contacto' , "Para Confirmar click en un botón Ok" , QMessageBox.Ok | QMessageBox.No | QMessageBox.Cancel, QMessageBox.Cancel)
                    if ret == QMessageBox.Ok: 
